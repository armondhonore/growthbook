...
**Live:** [https://relaxed-weasel-growthbook.cloud.nexlayer.ai](https://relaxed-weasel-growthbook.cloud.nexlayer.ai)  
...
**growthbook** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/growthbook/growthbook:latest
    path: /
    servicePorts:
    - 3000
    vars:
      MONGODB_URI: "mongodb://mongo.pod:27017/growthbook"
      APP_ORIGIN: "https://relaxed-weasel-growthbook.cloud.nexlayer.ai"
      API_HOST: "https://relaxed-weasel-growthbook.cloud.nexlayer.ai"
